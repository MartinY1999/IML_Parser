...
std::string DataParser::createRegexAndReturnTagCommand(const std::string& line, const std::string& frontTag, const std::string& backTag, bool isLast)
{
